...
class TrueInsert(TrueBase):
    ...
    def get_insert_trajectory(self,real_pose,all_info,sleeve_type):
        ...
        for i in range( int(total_ang / delta_angle + 1) ):
            ...
            if sleeve_type=='hex_bolt_8':
                ...
                tgt_pose_in_real_frame.position.z = -self.z_shift  + tamp_depth + 0.039
    ...
    def get_tgt_pose_in_world_frame(self,all_info):
        ...
        tgt_pose_in_real_frame.position.z = -self.z_shift - 0.025
    ...
    def action(self, all_info, pre_result_dict,kalman,yolo,plc,sleeve_type):
        ...
        if True:
            ...
            rospy.Subscriber("/robot_A/wrench", WrenchStamped, self.force_callback)
            rospy.sleep(0.1)
