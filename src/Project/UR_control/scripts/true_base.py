...
class TrueBase(object):
    def __init__(self, group_):
        ...
        self.group = group_
        self.effector = sys.argv[1] if len(sys.argv) > 1 else 'robot_A/tool0'
        ...
        # self.x_shift= 0.00064
        # self.y_shift= -0.00029
        # self.z_shift= 0.5022
        self.x_shift= -0.007
        self.y_shift= 0.001
        self.z_shift= 0      
    ...
    def set_arm_pose(self, group, pose, effector):
        joint_states = rospy.wait_for_message("robot_A/joint_states",JointState)
    ...
    def adjust_bolt_frame(self, X1_pose, all_info):
        ...
        real_trans.header.frame_id = "robot_A/base_link"
