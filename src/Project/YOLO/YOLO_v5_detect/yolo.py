...
class YOLO(object):
    _defaults = {
        "model_path": '/workspace/src/Project/YOLO/YOLO_v5_detect/model_data/black_new_weights.pth',
        "classes_path": '/workspace/src/Project/YOLO/YOLO_v5_detect/model_data/voc_classes.txt',
        "anchors_path": '/workspace/src/Project/YOLO/YOLO_v5_detect/model_data/yolo_anchors.txt',
