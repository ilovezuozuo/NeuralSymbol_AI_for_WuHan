...
echo_and_run cd "/workspace/src/Official_package/handeye/easy_handeye/rqt_easy_handeye"
...
echo_and_run /usr/bin/env \
    ...
    "/workspace/src/Official_package/handeye/easy_handeye/rqt_easy_handeye/setup.py" \
    egg_info --egg-base /workspace/build/Official_package/handeye/easy_handeye/rqt_easy_handeye \
    build --build-base "/workspace/build/Official_package/handeye/easy_handeye/rqt_easy_handeye" \
    install \
    --root="${DESTDIR-/}" \
