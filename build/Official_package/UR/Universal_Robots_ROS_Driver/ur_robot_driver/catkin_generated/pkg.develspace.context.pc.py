...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/src/Official_package/UR/Universal_Robots_ROS_Driver/ur_robot_driver/include;/usr/include;/opt/ros/noetic/include".split(';') if "/workspace/src/Official_package/UR/Universal_Robots_ROS_Driver/ur_robot_driver/include;/usr/include;/opt/ros/noetic/include" != "" else []
